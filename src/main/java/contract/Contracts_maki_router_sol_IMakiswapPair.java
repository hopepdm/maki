...
public class Contracts_maki_router_sol_IMakiswapPair extends Contract {
    ...
    @Deprecated
    protected Contracts_maki_router_sol_IMakiswapPair(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected Contracts_maki_router_sol_IMakiswapPair(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected Contracts_maki_router_sol_IMakiswapPair(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected Contracts_maki_router_sol_IMakiswapPair(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static Contracts_maki_router_sol_IMakiswapPair load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Contracts_maki_router_sol_IMakiswapPair(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Contracts_maki_router_sol_IMakiswapPair load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Contracts_maki_router_sol_IMakiswapPair(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Contracts_maki_router_sol_IMakiswapPair load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new Contracts_maki_router_sol_IMakiswapPair(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Contracts_maki_router_sol_IMakiswapPair load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new Contracts_maki_router_sol_IMakiswapPair(contractAddress, web3j, transactionManager, contractGasProvider);
    }
